...
namespace Microsoft.Bot.Builder.Dialogs.Adaptive.Conditions
{
    ...
    public class OnActivity : OnDialogEvent
    {
        ...
        public override Expression GetExpression()
        {
            ...
            return Expression.AndExpression(Expression.Parse($"{TurnPath.DIALOGEVENT}.name == '{AdaptiveEvents.ActivityReceived}' && {TurnPath.DIALOGEVENT}.value.type == '{this.Type}'"), base.GetExpression());
        }
    }
}
